...
function Navbar() {
  ...
  return (
    <div className='w-full flex justify-between items-center p-4 sm:p-6 sm:px-24 absolute top-0'>
      <h1 className='text-3xl sm:text-5xl font-bold text-gray-800'>AUTH!</h1>
      {userData ?
      <div onClick={() => setShowMenu(!showMenu)} className='w-8 h-8 flex justify-center items-center rounded-full bg-black text-white relative cursor-pointer'>
